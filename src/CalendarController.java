...
/**
 * The CalendarController class carries out the tasks that are requested by the view.
 */
public class CalendarController {
    ...
    public final static String[] dayOfWeek = {"", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"};
    ...
    /**
     * Set the agenda view to a specific agenda view.
